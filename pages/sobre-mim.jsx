...
//PDFs
import curriculoPTBR from "../public/pdf/CV_ABOUD_FR.pdf";
import curriculoENUS from "../public/pdf/CV_ABOUD_EN.pdf";
...
export default function SobreMim(props) {
	...
	useEffect(() => {
		async function fetchGithubStats() {
			const response = await fetch("https://api.github.com/users/cyberaboud");
