...
export default function HomePage() {
	...
	return (
		<SectionHomePage id="section-home">
			...
			<Head
				title="Mohamed Taher Aboud | Portfolio"
				metaDescription="Mohamed Taher Aboud | Portfolio"
				keywords="Mohamed Taher Aboud, Mohamed Taher, Aboud, Cybersecurity, Red Team, Penetration Testing"
			/>
			<LandingPageContainer>
				<TitleLandingContainer>
					<SubTitleLanding>{language.landingPage.apresentationText}</SubTitleLanding>
					<Typed strings={[language.landingPage.secondTypeText]} typeSpeed={30} className="type-string " />
					<SubTitleLanding>{language.landingPage.resumeText}</SubTitleLanding>
					<Link href="#section-sobre-mim" onClick={scrollToSection}>
